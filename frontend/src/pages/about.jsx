...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col items-center pt-5">
      ...
      <div className="w-full max-w-[1400px] mt-10 bg-sky-100 rounded-[32px] outline outline-1 outline-offset-[-1px] outline-slate-300 overflow-hidden p-10 flex flex-col relative">
        ...
        <div className="flex flex-col justify-center items-center mt-20 px-10">
          <h1 className="text-5xl font-bold text-black mb-10 font-['Plus_Jakarta_Sans']">
            About Me
          </h1>
          <p className="text-2xl text-black font-normal font-['Plus_Jakarta_Sans'] leading-[50px] max-w-[1000px] text-center">
